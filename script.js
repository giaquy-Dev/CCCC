...
const commands = [
    ...
    {
        name: "config",
        description: "my hardware configuration",
    },
    {
        name: "clear",
  ...
  {
    name: "grrr",
    description: "sexyyyy surprise",
  },
];

const links = {
  "github": "https://github.com/giaquy-dev",
  "twitch": "https://www.twitch.tv/mmbhehe",
  "tiktok": "https://www.tiktok.com/@dgq_devharu",
  "instagram": "https://instagram.com/kerajaanistana",
};
...
const commandFunctions = {
  ...
  config: function () {
    // Read about section from about.html
    // return aboutText;
    const project = FileSystem.readFile("commands/config.html");
    return project;
  },
  contact: function () {
    // Read about section from about.html
